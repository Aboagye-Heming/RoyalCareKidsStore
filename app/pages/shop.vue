    ...
    <section class="py-20">
      <div class="container mx-auto px-6">
        ...
        <div class="flex flex-col gap-6 mb-16">
          ...
          <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div class="flex flex-wrap gap-3">
              ...
              >
                {{ cat }}
                <span class="ml-1 font-medium normal-case tracking-normal opacity-60">({{ categoryCounts[cat] }})</span>
              </button>
            </div>
            <div class="flex items-center gap-4 shrink-0">
              <span class="text-sm font-bold text-slate-400 uppercase tracking-widest">Sort:</span>
          ...
          <div class="flex flex-wrap items-center gap-4">
            <span class="text-sm font-bold text-slate-400 uppercase tracking-widest shrink-0">Price:</span>
            <div class="flex items-center gap-3">
              <div class="relative">
                <span class="absolute inset-y-0 left-3 flex items-center text-slate-400 text-xs font-bold pointer-events-none">GHS</span>
                <input
              ...
              <button
                ...
                @click="minPrice = null; maxPrice = null; currentPage = 1"
        ...
        <div v-if="paginatedProducts.length === 0" class="py-20 text-center">
          <Icon name="lucide:search-x" class="text-6xl text-slate-200 mb-4 mx-auto" />
          <p class="text-xl font-bold text-slate-400 mb-2">No products found.</p>
          <p class="text-slate-300 mb-8">Try adjusting your search or filters.</p>
          <button
            @click="resetFilters"
...
useHead({
  ...
  meta: [
    { name: 'description', content: 'Browse our premium collection of baby and kids clothing, accessories, gifts, and mothercare items. Shop online with delivery across Accra, Ghana.' },
    { property: 'og:title', content: 'Shop the Royal Collection | Royal Care Kids Store' },
    { property: 'og:description', content: 'Premium baby & kids essentials curated with love. Clothing, accessories, gifts and more. Delivered across Accra, Ghana.' },
